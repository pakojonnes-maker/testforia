...
export const UI_STRINGS: Record<string, Record<string, string>> = {
  ...
  reserve: { es: 'Reservar', en: 'Reserve', fr: 'Réserver', de: 'Reservieren', it: 'Prenota', pt: 'Reservar', ca: 'Reservar', ar: 'احجز', ru: 'Забронировать', uk: 'Забронювати', zh: '预订', ja: '予約する', ko: '예약하기' },
  reserve_title: { es: 'Reservar mesa', en: 'Book a table', fr: 'Réserver une table', de: 'Tisch reservieren', it: 'Prenota un tavolo', pt: 'Reservar mesa', ca: 'Reservar taula', ar: 'حجز طاولة', ru: 'Забронировать столик', uk: 'Забронювати столик', zh: '预订餐桌', ja: 'テーブルを予約', ko: '테이블 예약' },
  eat_heading: { es: 'Dónde comer', en: 'Where to eat', fr: 'Où manger', de: 'Wo essen', it: 'Dove mangiare', pt: 'Onde comer', ca: 'On menjar', ar: 'أين تأكل', ru: 'Где поесть', uk: 'Де поїсти', zh: '去哪儿吃', ja: '食事はどこで', ko: '어디서 먹을까' },
  open: { es: 'Abrir', en: 'Open', fr: 'Ouvrir', de: 'Öffnen', it: 'Apri', pt: 'Abrir', ca: 'Obre', ar: 'فتح', ru: 'Открыть', uk: 'Відкрити', zh: '打开', ja: '開く', ko: '열기' },
  book_phone: { es: 'Reservar por teléfono', en: 'Book by phone', fr: 'Réserver par téléphone', de: 'Telefonisch reservieren', it: 'Prenota per telefono', pt: 'Reservar por telefone', ca: 'Reservar per telèfon', ar: 'الحجز عبر الهاتف', ru: 'Забронировать по телефону', uk: 'Забронювати за телефоном', zh: '电话预订', ja: '電話で予約', ko: '전화로 예약' },
  view_video_menu: { es: 'Ver carta en vídeo', en: 'Watch video menu', fr: 'Voir la carte en vidéo', de: 'Video-Speisekarte ansehen', it: 'Vedi il menù in video', pt: 'Ver menu em vídeo', ca: 'Veure la carta en vídeo', ar: 'عرض قائمة الطعام بالفيديو', ru: 'Смотреть видеоменю', uk: 'Переглянути відеоменю', zh: '观看视频菜单', ja: '動画メニューを見る', ko: '동영상 메뉴 보기' },
  ...
  experience_toggle_paid: { es: 'Premium', en: 'Premium', fr: 'Premium', de: 'Premium', it: 'Premium', pt: 'Premium', ca: 'Premium', ar: 'مميز', ru: 'Премиум', uk: 'Преміум', zh: '尊享', ja: 'プレミアム', ko: '프리미엄' },
  ...
  add_one: { es: 'Añadir uno', en: 'Add one', fr: 'Ajouter un', de: 'Eins hinzufügen', it: 'Aggiungi uno', pt: 'Adicionar um', ca: "Afegeix-ne un", ar: 'إضافة واحد', ru: 'Добавить один', uk: 'Додати один', zh: '增加一件', ja: '1つ追加', ko: '하나 추가' },
  remove_one: { es: 'Quitar uno', en: 'Remove one', fr: 'Retirer un', de: 'Eins entfernen', it: 'Rimuovi uno', pt: 'Remover um', ca: "Treu-ne un", ar: 'إزالة واحد', ru: 'Убрать один', uk: 'Прибрати один', zh: '减少一件', ja: '1つ減らす', ko: '하나 빼기' },
