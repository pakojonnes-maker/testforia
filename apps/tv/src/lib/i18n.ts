/**
 * Copy de interfaz para la pantalla TV — solo las 2 claves que hacen falta hoy.
 *
 * El resto de la app sigue en español fijo (no hay un sistema de i18n general
 * aquí todavía). Estas dos SÍ llevan traducción porque reutilizan texto que ya
 * existe en otra parte de la plataforma, en vez de inventarlo:
 *  - `quick_guides` es el mismo string que `apps/guide/src/lib/i18n.ts`.
