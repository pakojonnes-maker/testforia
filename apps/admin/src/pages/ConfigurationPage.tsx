...
const styles: any = {
  errorContainer: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', padding: '2rem', backgroundColor: '#0f172a', color: '#f8fafc' },
  loadingContainer: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', backgroundColor: '#0f172a', color: '#f8fafc' },
  spinner: { width: '40px', height: '40px', border: '4px solid rgba(255, 255, 255, 0.1)', borderTop: '4px solid #3B82F6', borderRadius: '50%', animation: 'spin 1s linear infinite' },
  container: { maxWidth: '1200px', margin: '0 auto', padding: '2rem', fontFamily: '-apple-system, sans-serif', backgroundColor: '#0f172a', minHeight: '100vh', color: '#f8fafc' },
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' },
  title: { fontSize: '2rem', fontWeight: '700', color: '#f8fafc', margin: '0 0 0.5rem 0' },
  subtitle: { fontSize: '1rem', color: '#94a3b8', margin: 0 },
  tabsContainer: { display: 'flex', gap: '0.5rem', marginBottom: '2rem', borderBottom: '2px solid rgba(255, 255, 255, 0.1)' },
  ...
  sectionTitle: { fontSize: '1.5rem', fontWeight: '600', color: '#f8fafc', margin: '0 0 1.5rem 0' },
  ...
  label: { fontSize: '0.9rem', fontWeight: '600', color: '#94a3b8', marginBottom: '0.5rem' },
  required: { color: '#EF4444' },
  input: { padding: '0.75rem', fontSize: '1rem', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '8px', outline: 'none', fontFamily: 'inherit', backgroundColor: 'rgba(255, 255, 255, 0.03)', color: '#f8fafc' },
  textarea: { resize: 'vertical', minHeight: '100px' },
  checkboxGroup: { display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '1.5rem' },
  checkbox: { display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer', color: '#cbd5e1' },
